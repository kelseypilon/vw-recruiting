  ...
  function handlePreview(e: React.FormEvent) {
    ...
    if (interviewType === "1on1") {
      ...
      if (groupTemplate) {
        ...
        emailSubject = `Group Interview Invitation \u2014 ${team?.name ?? "Vantage West"}`;
        emailBody = `Hi ${selectedCandidate.first_name},\n\nYou're invited to our upcoming group interview at ${team?.name ?? "Vantage West Real Estate"}.\n\nDate & Time: ${dateFormatted}\nZoom Link: ${zoomLink}\n\nPlease join a few minutes early and be prepared to introduce yourself.\n\nWe look forward to meeting you!\n\nBest,\n${team?.name ?? "Vantage West Recruiting"}`;
      }
    }
