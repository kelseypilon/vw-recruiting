...
export const DEFAULT_FORM_FIELDS: ApplicationFormField[] = [
  ...
  { id: "referral_source", label: "How did you hear about us?", type: "select", required: false, locked: false, order: 9, options: ["Referral", "Social Media", "Job Board", "Website", "Other"] },
  { id: "hours_per_week", label: "Hours per week you can commit?", type: "select", required: true, locked: false, order: 10, options: ["20-30", "30-40", "40-50", "50+"] },
  { id: "why_real_estate", label: "Why do you want to be in real estate?", type: "textarea", required: true, locked: false, order: 11 },
  { id: "why_vantage", label: "Why this company specifically?", type: "textarea", required: true, locked: false, order: 12 },
  { id: "biggest_achievement", label: "What is your biggest professional achievement?", type: "textarea", required: true, locked: false, order: 13 },
  { id: "one_year_goal", label: "Where do you want to be in 1 year?", type: "textarea", required: true, locked: false, order: 14 },
  { id: "interested_in", label: "Interested In", type: "interested_in", required: false, locked: false, order: 15 },
];
